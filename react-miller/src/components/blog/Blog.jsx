      ...
      <div className="blog__container container grid">
        <div className="blog__item card card-two">
          ...
          <p className="blog__description">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laborum non, expedita dolores
            sequi accusamus a iure totam excepturi ducimus possimus molestias! Temporibus,
            voluptatibus. Asperiores eos unde atque beatae natus veritatis!
          </p>
