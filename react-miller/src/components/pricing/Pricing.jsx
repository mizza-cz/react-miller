      ...
      <div className="pricing__container container grid">
        <div className="pricing__item card card-one">
          ...
          <p className="pricing__description">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veniam, facere ex, delectus
            quas adipisci aliquid nam fugiat quisquam expedita quia labore praesentium aliquam Quae
            odit esse delectus molestias commodi?
          </p>
        ...
        <div className="pricing__item-wrapper">
          ...
          <div className="pricing__item card card-one">
            ...
            <p className="pricing__description">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veniam, facere ex, delectus
              quas adipisci aliquid nam fugiat quisquam expedita quia labore praesentium aliquam
              Quae odit esse delectus molestias commodi?
            </p>
            <ul className="pricing__list">
              <li className="list__item">
                <FaCheck className="list__icon"></FaCheck>
